...
<html>
<head>
<meta http-equiv="refresh" content="<%session.getMaxInactiveInterval(); %>; URL=LoginSignup.jsp"  >
<title>Member - Enlighten Home</title>
<link href="css/MemberHome.css" rel="stylesheet" type="text/css">
...
<div id="templatemo_content_wrapper">
	...
	<div id="templatemo_content">
        ...
        <div class="content_section">
            ...
            <h2><div id="loginName">Welcome :<%=session.getAttribute("email") %></div></h2>
            ...
            <div class="product_box margin_r10">
              ...
              <p class="price">Price: $180</p>
                <a href="#" title="flower box">Detail</a> | <a href="#">Add to cart</a>
            </div>
            ...
            <div class="product_box margin_r10">
                ...
                <img src="img2/3.jpg" alt="product" class="abcd">
                  ...
                  <p class="price">Price: $240</p>
                    <a href="#" title="some notes">Detail</a> | <a href="#">Add to cart</a>
            </div>
            ...
            <div class="product_box ">
              ...
              <p class="price">Price: $120</p>
                <a href="#" title="notes About Floweers" target="_blank">Detail</a> | <a href="#">Add to cart</a>
            </div>
        ...
        <h2>Member Exclusive Area</h2>
        
        	<img src="images/image_05.jpg" alt="image" class="fl_image">
                    
            <p class="em_text">Member Area  is a for brush.</p>
